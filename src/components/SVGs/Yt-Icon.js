const YtIcon = (props) => (
  <svg width="48" height="48" viewBox="0 0 48 48" fill="currentColor" {...props}>
  ...
  <defs>
  <filter id="filter0_d_3160_46" x="0" y="8" width="48" height="40" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
