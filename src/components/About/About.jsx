...
const About = () => {
  return (
    <section id="About" className="flex flex-col lg:flex-row items-center justify-center py-16">
      ...
      <div className="w-full lg:w-4/5 h-[90%] flex flex-col lg:flex-row justify-center items-center">
        ...
        <div className="about-text w-4/5 flex flex-col justify-around">
          ...
          <p className="mt-4 font-body text-base font-normal w-4/5 md:w-3/5 lg:w-full self-center lg:self-start">
            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
          </p>

          <div className="mt-8 border-y-2 border-secondary flex justify-center gap-10 w-1/2 md:w-1/3 lg:w-2/5 self-center lg:self-start">
        ...
        <div className="about-video flex justify-center items-center w-full">
          ...
          <video controls muted autoPlay loop playsInline className="mt-16 w-full lg:rounded-[20px] lg:w-[35rem]">
